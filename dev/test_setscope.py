...
async def main():
    soul_before = (scratch / "SOUL.md").read_text(encoding="utf-8")
    ...
    soul1 = (scratch / "SOUL.md").read_text(encoding="utf-8")
    ...
    gem1 = (scratch / "GEMINI.md").read_text(encoding="utf-8")
    ...
    soul2 = (scratch / "SOUL.md").read_text(encoding="utf-8")
    ...
    soul3 = (scratch / "SOUL.md").read_text(encoding="utf-8")
    ...
    check("a/an: 'infrastructure' gets 'an'",
          (scratch / "SOUL.md").read_text(encoding="utf-8").startswith("You are an infrastructure assistant for"))
    await mod.cmd_setscope(upd(), ctx(["general-purpose"]))
    check("a/an: 'general-purpose' gets 'a'",
          (scratch / "SOUL.md").read_text(encoding="utf-8").startswith("You are a general-purpose assistant for"))
    ...
    check("...and truly changed nothing",
          "nothing template-shaped here at all" in (scratch / "SOUL.md").read_text(encoding="utf-8"))
